...
EDA 软件的菜单、文件格式和工作流会随版本与许可证模块变化。
本章强调跨工具稳定的设计流程；具体按钮和导出选项应以当前安装版本的官方文档、制造商 CAM 要求和团队模板为准。
...
\begin{itemize}
  \item IPC-2221 的经验公式适合粗略估算；更可靠的温升评估应参考 IPC-2152、实际层叠、铜面积、环境和散热条件
  \item 考虑温升限制
  \item 考虑内层和外层差异
  \item 考虑铜箔厚度
\end{itemize}
...
以下尺寸只是常见板厂能力的示例，不是通用设计规则；下单前必须使用目标板厂的最小孔径、纵横比、环宽和叠孔限制：
...
\begin{itemize}
  \item 过孔之间、过孔到走线及焊盘的间距由电压、阻焊桥、钻孔公差和制造能力共同决定
  \item 高速网络还需检查过孔残桩、回流路径、反焊盘和参考平面切换
\end{itemize}
